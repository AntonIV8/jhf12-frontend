...
moduleForModel('data-line-jhf12-resource-spec-characteristic', 'Unit | Serializer | data-line-jhf12-resource-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-jhf12-resource-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
