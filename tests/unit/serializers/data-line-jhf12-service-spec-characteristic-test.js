...
moduleForModel('data-line-jhf12-service-spec-characteristic', 'Unit | Serializer | data-line-jhf12-service-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-jhf12-service-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
