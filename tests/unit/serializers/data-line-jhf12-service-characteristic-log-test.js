...
moduleForModel('data-line-jhf12-service-characteristic-log', 'Unit | Serializer | data-line-jhf12-service-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-jhf12-service-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
