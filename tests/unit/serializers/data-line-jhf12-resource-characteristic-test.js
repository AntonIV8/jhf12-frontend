...
moduleForModel('data-line-jhf12-resource-characteristic', 'Unit | Serializer | data-line-jhf12-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-jhf12-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
