...
moduleForModel('data-line-jhf12-service-characteristic', 'Unit | Serializer | data-line-jhf12-service-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-jhf12-service-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
